package com.tripleying.dogend.module.playermail.gui;
...
public class AdminMailConfig extends ReplaceConfig {
    ...
    static {
        ...
        rmap.put("players", new ReplacePackage(
                "players",
                "收件玩家列表",
                ReplaceType.StringList,
                sm -> ((AdminSystemMail)sm).getPlayers(),
                (sm, o) -> ((AdminSystemMail)sm).setPlayers((List<String>)o))
        );
    ...
    public AdminMailConfig(SystemMail sm, Player p){
        super(sm, p);
    }
    ...
    public static void registerConfig(){
        ReplaceConfig.registerConfig(AdminSystemMail.class, AdminMailConfig.class);
    }
    
    public static void unregisterConfig(){
        ReplaceConfig.unregisterConfig(AdminSystemMail.class);
    }
