package com.tripleying.dogend.mailbox.module.templatemail.gui;
...
public class TemplateMailConfig extends ReplaceConfig {
    ...
    public TemplateMailConfig(SystemMail sm, Player p){
        super(sm, p);
    }
    ...
    public static void registerConfig(){
        ReplaceConfig.registerConfig(TemplateSystemMail.class, TemplateMailConfig.class);
    }
    
    public static void unregisterConfig(){
        ReplaceConfig.unregisterConfig(TemplateSystemMail.class);
    }
