package com.tripleying.dogend.mailbox.module.permissionmail.gui;
...
public class PermissionMailConfig extends ReplaceConfig {
    ...
    static {
        ...
        rmap.put("permission", new ReplacePackage(
                "permission",
                "所需权限",
                ReplaceType.String,
                sm -> ((PermissionSystemMail)sm).getPermission(),
                (sm, o) -> ((PermissionSystemMail)sm).setPermission((String)o))
        );
    ...
    public PermissionMailConfig(SystemMail sm, Player p){
        super(sm, p);
    }
    ...
    public static void registerConfig(){
        ReplaceConfig.registerConfig(PermissionSystemMail.class, PermissionMailConfig.class);
    }
    
    public static void unregisterConfig(){
        ReplaceConfig.unregisterConfig(PermissionSystemMail.class);
    }
